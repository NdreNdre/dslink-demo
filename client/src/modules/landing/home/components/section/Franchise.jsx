...
const features = [
    { icon: GraduationCap, title: "Training Lengkap", desc: "Training tim toko + roleplay + scoring performa" },
    { icon: Megaphone, title: "Support Marketing", desc: "Sales script, WA pipeline, dan strategi promosi" },
    { icon: Headphones, title: "Customer Care Support", desc: "Tim support siap bantu operasional harian" },
    { icon: BarChart3, title: "Monitoring KPI", desc: "Pendampingan & evaluasi performa fase awal" },
];
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 ref={headingRef} className="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                        Bangun Bisnis Bersama Franchise{" "}
                        <span className="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">
                            DS LINK
                        </span>
                    </h2>
                    <p ref={subheadRef} className="text-slate-300 text-lg leading-relaxed">
                        Sistem yang sudah teruji, dukungan lengkap, dan strategi operasional
                        yang siap dijalankan. Pilih paket sesuai level kesiapan investasi Anda.
                    </p>
                </div>
                    ...
                    <div ref={statsRef} className="bg-slate-800 border border-slate-700 px-12 py-6 rounded-2xl flex gap-20 shadow-2xl">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="text-slate-400 text-sm">Mitra Aktif</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                    ...
                    {/* DS LINK */}
                    <div ref={card0Ref} className="group relative bg-white/[0.04] backdrop-blur-xl border border-white/10 p-10 rounded-3xl transition-all duration-500 hover:-translate-y-2 hover:border-white/20">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/10 text-white">
                                <BsStars size={22} />
                            </div>
                            <h3 className="text-2xl font-semibold text-white tracking-wide">DS LINK</h3>
                        </div>
                        <p className="text-slate-400 leading-relaxed mb-8">Outlet siap operasional dengan sistem & SOP lengkap.</p>
                        <div className="grid grid-cols-2 gap-2 mb-8">
                            {[
                                { icon: "📦", label: "Stok Awal", value: "Siap Jual" },
                                { icon: "📋", label: "SOP", value: "Lengkap" },
                                { icon: "🎯", label: "Training", value: "Intensif" },
                                { icon: "📱", label: "WA Pipeline", value: "Siap Pakai" },
                                ...
                                <div key={label} className="flex items-center gap-2.5 bg-white/5 hover:bg-blue-500/10 border border-white/20 rounded-xl px-3 py-2.5 transition-colors duration-200">
                                    <div className="w-8 h-8 rounded-lg bg-blue-400/10 flex items-center justify-center text-sm flex-shrink-0">{icon}</div>
                                    <div>
                        ...
                        <ul className="space-y-4 text-slate-300 text-sm">
                            {["SOP harian toko & display", "Sales script & WA pipeline", "Paket produk hero + bundling", "Training + monitoring KPI"].map((item, i) => (
                    ...
                    {/* DS LINK PLUS */}
                    <div ref={card1Ref} className="group relative bg-white/[0.06] backdrop-blur-xl border border-blue-500/30 p-10 rounded-3xl transition-all duration-500 hover:-translate-y-2 hover:border-blue-400/40 shadow-[0_20px_60px_rgba(59,130,246,0.15)]">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h3 className="text-2xl font-semibold text-white tracking-wide">DS LINK PLUS</h3>
                        </div>
                        <p className="text-slate-300 leading-relaxed mb-8">Lebih siap tampil premium & agresif sejak opening.</p>
                        <div className="grid grid-cols-2 gap-2 mb-8">
                            {[
                                { icon: "🏪", label: "Display", value: "Modern & Premium" },
                                { icon: "🎨", label: "Branding", value: "Signage Fisik" },
                                { icon: "🔨", label: "Renovasi", value: "Termasuk" },
                                { icon: "🚀", label: "Support", value: "Opening Intensif" },
                            ].map(({ icon, label, value }) => (
                        ...
                        <div className="border-t border-white/10 my-8" />
                        <ul className="space-y-4 text-slate-300 text-sm">
                            {["Semua fitur DS Link", "Rak & display modern", "Signage & branding fisik", "Renovasi & pembenahan", "Toolkit promo & support opening intensif"].map((item, i) => (
                                <li key={i} className="flex items-start gap-3">
                                    <Check size={18} className="text-blue-400 mt-1" /><span>{item}</span>
                                </li>
                            ))}
                ...
                <div className="mt-24 max-w-6xl mx-auto">
                    <div ref={tableHeaderRef} className="text-center mb-12">
                        ...
                        <p className="text-slate-400 mt-3">Perbandingan cepat fitur utama antara DS Link dan DS Link Plus</p>
                    </div>
