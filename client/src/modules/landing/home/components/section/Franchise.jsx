...
const features = [
    ...
    { icon: FaCreditCard, title: "Multi Partner Cicilan",  desc: "Stok dari gudang distributor, harga kompetitif" },
                    ...
                    >
                        ...
                        <ul className="space-y-4 text-sm flex-1" style={{ color: "#1A3A8F" }}>
                            {[
                                ...
                                "Akses Multi partner pembiayaan (BRI, BCA, BNI, Mandiri, Home Credit, Akulaku, Kredivo, Indodana)",
