...
import { useDetailPackageStore } from '../../../package/detail/stores/detailPackage.store';
...
export default function CTASection() {
    ...
    return (
        ...
        <div ref={ref} className="reveal relative z-10">
            ...
            <em className="text-blue-300 not-italic">Sampai Sekarang.</em>
            </h2>
            ...
            <button className="bg-transparent text-white/80 border border-white/25 hover:border-blue-300 hover:text-blue-300 px-7 py-4 rounded-full text-sm font-normal transition-all duration-200" onClick={handleScrollFranchise}>
